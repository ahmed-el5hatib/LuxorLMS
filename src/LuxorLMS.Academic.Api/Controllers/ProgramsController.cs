...
public class ProgramsController : ControllerBase
{
    ...
    [RequirePermissionFilterFactory(AcademicPermissions.ProgramRead)]
    public async Task<IActionResult> GetByDepartment(Guid departmentId, CancellationToken cancellationToken)
    {
        var result = await _service.GetByDepartmentIdAsync(departmentId, cancellationToken);
    ...
    [HttpPost]
    [RequirePermissionFilterFactory(AcademicPermissions.ProgramManage)]
    public async Task<IActionResult> Create([FromBody] CreateProgramRequest request, CancellationToken cancellationToken)
    {
    ...
    [HttpPut("{id:guid}")]
    [RequirePermissionFilterFactory(AcademicPermissions.ProgramManage)]
    public async Task<IActionResult> Update(Guid id, [FromBody] UpdateProgramRequest request, CancellationToken cancellationToken)
    {
