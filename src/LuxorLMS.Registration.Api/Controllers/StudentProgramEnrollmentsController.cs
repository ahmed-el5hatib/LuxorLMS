...
[ApiController]
[Route("api/v1/registration/student-programs")]
public class StudentProgramEnrollmentsController : ControllerBase
{
    private readonly IStudentProgramEnrollmentService _service;

    public StudentProgramEnrollmentsController(IStudentProgramEnrollmentService service)
    {
        _service = service;
    }
    ...
    [HttpPost]
    [RequirePermissionFilterFactory(RegistrationPermissions.PeriodManage)]
    public async Task<IActionResult> Create([FromBody] CreateStudentProgramEnrollmentRequest request, CancellationToken cancellationToken)
    {
    ...
    [HttpPut("{id:guid}")]
    [RequirePermissionFilterFactory(RegistrationPermissions.PeriodManage)]
    public async Task<IActionResult> Update(Guid id, [FromBody] UpdateStudentProgramEnrollmentRequest request, CancellationToken cancellationToken)
    {
